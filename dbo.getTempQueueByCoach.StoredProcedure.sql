USE [_connector]
GO
/****** Object:  StoredProcedure [dbo].[getTempQueueByCoach]    Script Date: 8/16/2017 8:45:18 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[getTempQueueByCoach]
...
BEGIN
    ...
    -- Insert statements for procedure here
      ...
      ,DecisionToday,
		...
		where status = 2 and teams.TeamCoachID = @SupervisorID)
		or ConnectorID=@SupervisorID
